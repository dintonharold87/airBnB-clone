...
export default function Card({ image, alt, rating, figure, cardparagraph, cardheading,location }) {
      ...
      <div className="container flex flex-row mx-auto w-1/2">
        ...
        >
          ...
          >
            ...
            >
              <div className="Frame4 inline-flex flex-col items-start justify-start">
                <img
                  src={`../images/${image}`}
